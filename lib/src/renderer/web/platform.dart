...
import 'package:pdfx_plugin/src/renderer/interfaces/document.dart';
import 'package:pdfx_plugin/src/renderer/interfaces/page.dart';
import 'package:pdfx_plugin/src/renderer/interfaces/platform.dart';
import 'package:pdfx_plugin/src/renderer/rgba_data.dart';
import 'package:pdfx_plugin/src/renderer/web/pdfjs.dart';
import 'package:pdfx_plugin/src/renderer/web/resources/document_repository.dart';
import 'package:pdfx_plugin/src/renderer/web/resources/page_repository.dart';
...
class PdfxWeb extends PdfxPlatform {
  PdfxWeb() {
    assert(
        ...
        'Run «flutter pub run pdfx_plugin:install_web» or add script manually');
